class WorkersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @worker.save
        format.html { redirect_to worker_url(@worker), notice: "Рабочий был успешно создан." }
  ...
  def update
    respond_to do |format|
      if @worker.update(worker_params)
        format.html { redirect_to worker_url(@worker), notice: "Рабочий был успешно обновлен." }
